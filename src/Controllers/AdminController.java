...
//        this.birthDateId.setText("");
    ...
    public void generateStatistics(ActionEvent actionEvent) {
        ...
        try{
            ...
            HSSFSheet sheet2 = workbook.createSheet("Palabrass");
            HSSFRow rowhead2 = sheet2.createRow((short) 0);
            rowhead2.createCell((short) 0).setCellValue("idWord");
            rowhead2.createCell((short) 1).setCellValue("word");
            rowhead2.createCell((short) 2).setCellValue("category");
            rowhead2.createCell((short) 3).setCellValue("quantitySyllables");
            int j = 1;
            while (rs2.next()){
            ...
            String urlFile = "D:\\prueba\\test3.xls";
